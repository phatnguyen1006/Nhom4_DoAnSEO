...
<div id="nicdark_header_img_archive" class="nicdark_section nicdark_border_bottom_1_solid_grey">
    ...
    <div class="nicdark_container nicdark_clearfix">
    	...
    	<div class="nicdark_grid_12">
    		...
    		<?php if (is_category()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Category','motela'); ?></h1>
			...
			<?php elseif (is_tag()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Tag','motela'); ?></h1>
				<div class="nicdark_section nicdark_height_20"></div>
			...
			<?php elseif (is_month()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Archive for','motela'); ?></h1>
				<div class="nicdark_section nicdark_height_20"></div>
			...
			<?php elseif (is_author()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Author','motela'); ?></h1>
				<div class="nicdark_section nicdark_height_20"></div>
			...
			<?php elseif (is_search()): ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Search for','motela'); ?></h1>
				<div class="nicdark_section nicdark_height_20"></div>
			...
			<?php else: ?>
				<h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php esc_html_e('Archive','motela'); ?></h1>
			<?php endif ?>
    	...
    	<?php } ?>
			...
			<div class="nicdark_section">
		    	...
		    	the_posts_pagination( array(
					'prev_text'          => esc_html__( 'Prev', 'motela' ),
					'next_text'          => esc_html__( 'Next', 'motela' ),
					'before_page_number' => '<span class="meta-nav screen-reader-text">' . esc_html__( 'Page', 'motela' ) . ' </span>',
				) );
