...
<div class="nicdark_section nicdark_border_bottom_1_solid_grey">
    ...
    <div class="nicdark_container nicdark_clearfix">
        ...
        <div class="nicdark_grid_12">
            ...
            <h1 class="nicdark_font_size_50 nicdark_font_size_40_all_iphone nicdark_line_height_40_all_iphone nicdark_text_align_center nicdark_font_weight_600"><?php the_title(); ?></h1>
    ...
    <?php if(have_posts()) :
        while(have_posts()) : the_post(); ?>
            ...
            <div class="nicdark_section">
                ...
                <?php $args = array(
                    'before'           => '<!--link pagination--><div id="nicdark_link_pages" class="nicdark_section"><p class="nicdark_margin_0 nicdark_first_font nicdark_color_greydark nicdark_display_inline nicdark_padding_0">',
                ...
                <?php if(has_tag()) { ?>  
                    ...
                    <div id="nicdark_tags_list" class="nicdark_section">
                         <?php the_tags( esc_html__('Tags : ', 'motela'),'',''); ?>
                    </div>
                    <!--END tag-->
                <?php } ?>
